...
sprite_sheet_image = pygame.image.load("C:/Users/benjamin chan/Documents/University/Degree Year 2 Sem 2/ISE Assignment/Finn_Running.png").convert_alpha()
...
unwanted_colors = [
    ...
    O5Green, O6Green, O7Green, O8Green
]
...
# Load all frames
for animation in Finn_animation_steps:
    temp_img_list = []
    for _ in range(animation):
        temp_img_list.append(sprite_sheet.get_image(step_counter, 66, 88, 1, unwanted_colors))
        step_counter += 1
